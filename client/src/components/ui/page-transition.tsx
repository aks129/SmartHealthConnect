...
// Slide from right transition (for page navigation)
export function SlideRightTransition({ children, className }: PageTransitionProps) {
  return (
    <motion.div
...
// Presence animation wrapper for items entering/leaving lists
...
export function PresenceWrapper({ children, className, delay = 0 }: PresenceWrapperProps) {
  return (
    <motion.div
